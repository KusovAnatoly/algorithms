...
<details>
  ...
  <ol>
    <li><a href="#перед-началом-работы">перед началом работы</a></li>
    <li><a href="#короткая-информация">короткая информация</a></li>
    <li><a href="#у-вас-нет-удаленного-репозитория-и-вам-нужно-создать-новый">у вас нет удаленного репозитория и вам нужно создать новый</a></li>
    <li><a href="#у-вас-есть-удаленный-репозиторий-и-он-полностью-пустой">у вас есть удаленный репозиторий и он полностью пустой</a></li>
    <li><a href="#у-вас-есть-удаленный-репозиторий-и-вам-необходимо-внести-в-него-изменения">у вас есть удаленный репозиторий и вам необходимо внести в него изменения</a></li>
    <li><a href="#как-изменить-ветку">как изменить ветку</a></li>
  </ol>
</details>
